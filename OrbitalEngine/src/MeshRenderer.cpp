...
namespace Orbital
{
	namespace Components
	{
		...
		MeshRenderer::MeshRenderer(const std::string& meshTag, Components::Transform* transform)
		...
		MeshRenderer::MeshRenderer(const std::string& meshTag, Components::Transform* transform, bool batchedDraw)
			: m_mesh(MeshManager::Get(meshTag))
			, m_material(MaterialManager::Get("Blank"))
			, m_transform(transform)
		{
		...
		MeshRenderer::MeshRenderer(const std::string& meshTag,
			Components::Transform* transform, bool batchedDraw,
